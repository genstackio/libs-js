export interface ITranslatorPlugin<T = any, U = any, V = any, W = string, X = any> {
    getTranslator?(config: Record<string, any>): Promise<[T, Record<string, true>|undefined, Record<string, true>|undefined, Record<string, any>|undefined]>;
    ...
    translate(t: any, texts: string[], sourceLocale: U, targetLocale: V, options: Record<string, any>|undefined): Promise<X[]>;
}
