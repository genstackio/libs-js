...
const Demo = ({ size = undefined, color, variant = undefined }: { size?: number; color; variant?: string }) => (
    <div
        style={{
            minWidth: variant === 'vertical' ? 70 : 'unset',
            marginBottom: variant === 'vertical' ? 'unset' : 15,
            marginRight: variant === 'vertical' ? 15 : 'unset',
        }}
    >
        ...
        <div
            style={{
                ...
                display: variant === 'vertical' ? 'inline-block' : 'flex',
