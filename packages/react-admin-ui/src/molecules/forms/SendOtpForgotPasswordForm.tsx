        ...
        <div className={'w-full flex flex-col'}>
            <div className='w-full flex justify-center'>
                <form onSubmit={handleSubmit(onSubmit as any)} className={'w-full'}>
                    ...
                    <Text className={'text-gray-500 mb-4'} text={t('form_forgot_password_send_otp_subtitle')} variant={'body'} color={color} />
                    <PhoneField {...field} required autoFocus />
                    <div className='flex justify-center mt-6'>
                        <Button className={'w-full items-center justify-center'} variant={'contained'} color={color}>{t('form_forgot_password_send_otp_submit_label')}</Button>
                    </div>
                </form>
            </div>
        </div>
