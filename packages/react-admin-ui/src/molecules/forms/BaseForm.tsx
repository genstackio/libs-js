...
export function BaseForm({title, subtitle, color, header, footer, children, onSubmit, rhf, submitting, errors = {}}: InternalBaseFormProps) {
        ...
        <div className={'w-full flex flex-col'}>
            ...
            <div className={'w-full flex justify-center flex-col'}>
                <form onSubmit={handleSubmit(onSubmit as any)} className={'w-full'} aria-disabled={submitting}>
                    ...
                    {subtitle && <Text className={'text-gray-500 mb-4'} text={subtitle} variant={'body'} color={color} />}
                    {error && (
