...
export const styles = {
    common: {
        ...
        'light-secondary': 'bg-white',
        'light-success': 'bg-white',
        'light-info': 'bg-white',
        'light-warning': 'bg-white',
        'light-danger': 'bg-white',
        'light-disabled': 'bg-white',
    ...
    nonDisabledStyles: {
        ...
        'light-none': 'bg-white focus:outline-none',
    },
    hoverable: {
        ...
        'contained-none': '',
        'light-primary': 'hover:bg-primary hover:bg-opacity-5',
