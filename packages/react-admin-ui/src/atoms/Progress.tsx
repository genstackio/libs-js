...
import { WithClassName, WithValueAsNumber, WithVariantOfProgress } from '../withs';
...
export interface ProgressProps extends WithClassName, WithVariantOfProgress, WithValueAsNumber {}
