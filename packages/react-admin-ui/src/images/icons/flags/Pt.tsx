    ...
    return (
        ...
        >
            ...
            >
                ...
                />
                <path
                    d="M344.853 297.3a143.02 143.02 0 01-2.77 4.086c-10.07 3.55-25.94 7.28-32.636 8.367-13.68 2.818-34.843 4.9-53.625 4.91-40.416-.592-73.5-8.504-89.063-15.253l-1.257-2.16.205-.323 2.13.826c27.678 9.902 58.764 13.853 88.21 14.562 18.71.066 37.436-2.144 52.58-4.852 23.222-4.653 32.612-8.16 35.493-9.75l.734-.41zm5.352-8.826c.023.028.047.054.07.083a287.226 287.226 0 01-2.093 3.48c-5.372 1.92-19.95 6.185-41.237 9.162-14.025 1.91-22.743 3.76-50.644 4.302-52.282-1.33-86.132-11.553-94.174-14.075l-1.192-2.286c30.3 7.91 61.25 13.433 95.37 13.997 25.525-.544 36.385-2.424 50.294-4.32 24.823-3.86 37.33-7.946 41.083-9.126a2.845 2.845 0 00-.164-.212l2.692-1.005-.002.002z"
                    strokeWidth={0.587}
                />
                <path
                ...
                <path
                    ...
                    strokeWidth={0.611}
                />
                <path d="M260.245 134.06h-9.05l.01 212.223h9.082z" strokeWidth={0.611} />
                <path
            ...
            <g transform="translate(0 26.667) scale(1.06667)">
                ...
                <g id="pt_svg__e">
                    <g id="pt_svg__d" fill="#ff0" stroke="#000" strokeWidth={0.5}>
                        ...
                        <path id="pt_svg__a" d="M190.94 141.56l.13 3.478h-4.124l.116-3.478h3.88-.002z" />
                        <use height="100%" width="100%" xlinkHref="#pt_svg__a" x={10.609} />
                        <path
                            id="pt_svg__b"
                        ...
                        />
                        <use height="100%" width="100%" xlinkHref="#pt_svg__b" x={10.609} />
                        <path
                        ...
                        <path
                            ...
                            stroke="none"
                        />
                        <use height="100%" width="100%" xlinkHref="#pt_svg__c" x={10.641} />
                    </g>
                    <use height="100%" width="100%" xlinkHref="#pt_svg__d" y={46.32} />
                    <use
                        height="100%"
                        width="100%"
                        xlinkHref="#pt_svg__d"
                ...
                <use height="100%" width="100%" xlinkHref="#pt_svg__d" x={45.714} />
                <use height="100%" width="100%" xlinkHref="#pt_svg__e" transform="matrix(-1 0 0 1 479.792 0)" />
                <g id="pt_svg__f" fill="#fff">
                    <path
                        d="M232.636 202.406v.005a8.34 8.34 0 002.212 5.69c1.365 1.467 3.245 2.378 5.302 2.378 2.067 0 3.944-.905 5.303-2.365 1.358-1.46 2.202-3.472 2.202-5.693v-10.768l-14.992-.013-.028 10.765"
                        fill="#039"
                    />
                ...
                <use height="100%" width="100%" xlinkHref="#pt_svg__f" y={-26.016} />
                <use height="100%" width="100%" xlinkHref="#pt_svg__f" x={-20.799} />
                <use height="100%" width="100%" xlinkHref="#pt_svg__f" x={20.745} />
                <use height="100%" width="100%" xlinkHref="#pt_svg__f" y={25.784} />
            </g>
        </svg>
    );
}
