    ...
    return (
        ...
        >
            ...
            <g transform="translate(-12.38 -30.751) scale(1.5986)">
                <path
                    d="M104.824 108.068c0 .81-.918 1.466-2.049 1.466-1.131 0-2.049-.656-2.049-1.466 0-.81.918-1.466 2.049-1.466 1.131 0 2.049.656 2.049 1.466z"
                    fillRule="evenodd"
                    fill="#f1eeee"
                />
                <path
                    d="M40.727 100.98v37.209h37.211c0 6.2 6.202 12.402 12.404 12.402v37.207h37.208v-37.207c6.202 0 12.404-6.202 12.404-12.402h37.211V100.98h-37.211c0-6.2-6.202-12.402-12.404-12.402V51.371H90.342v37.207c-6.202 0-12.404 6.202-12.404 12.402H40.727z"
                    fillRule="evenodd"
                    fill="#c00"
                />
                <path
                    d="M41.969 102.22v34.727H79.18c0 6.2 6.2 12.404 12.402 12.404v37.207h34.73v-37.207c6.202 0 12.402-6.204 12.402-12.404h37.211V102.22h-37.211c0-6.2-6.2-12.404-12.402-12.404V52.609h-34.73v37.207c-6.202 0-12.402 6.204-12.402 12.404H41.969z"
                    fillRule="evenodd"
                    fill="#ffe600"
                />
                <path
                    d="M43.209 103.46v32.249h37.208c0 6.2 6.202 12.402 12.404 12.402v37.207h32.248v-37.207c6.202 0 12.404-6.202 12.404-12.402h37.208V103.46h-37.208c0-6.2-6.202-12.402-12.404-12.402V53.851H92.821v37.207c-6.202 0-12.404 6.202-12.404 12.402H43.209z"
                    fillRule="evenodd"
                    fill="#707070"
                />
                <path
                ...
                <g fillRule="evenodd">
                    <path
                        d="M94.37 89.223c2.179 2.18.412 7.48-3.947 11.84s-9.66 6.125-11.84 3.946c-2.18-2.18-.413-7.48 3.946-11.84s9.66-6.126 11.84-3.946z"
                        fill="#d0d0d0"
                    />
                    <path
                        d="M91.74 91.852c2.18 2.18 1.59 6.303-1.316 9.209s-7.03 3.495-9.209 1.315c-2.18-2.18-1.59-6.302 1.316-9.208s7.029-3.495 9.209-1.316z"
                        fill="gray"
                    />
                    <path
                        d="M80.774 98.429l.877-.877 3.508 1.754-1.754-3.508.877-.877 3.508 7.016-7.016-3.508zm5.263-5.262l.877-.877 5.263 5.262-.877.877z"
                        fill="#d0d0d0"
                    />
                </g>
                <g fillRule="evenodd">
                    <path
                        d="M139.308 105.009c-2.18 2.18-7.481.412-11.84-3.947s-6.127-9.66-3.947-11.84c2.18-2.179 7.48-.412 11.84 3.947s6.126 9.66 3.947 11.84z"
                        fill="#d0d0d0"
                    />
                    <path
                        d="M136.678 102.38c-2.18 2.179-6.303 1.59-9.209-1.316s-3.495-7.03-1.315-9.209c2.18-2.18 6.302-1.59 9.209 1.316s3.495 7.029 1.315 9.208z"
                        fill="gray"
                    />
                    <path
                        d="M130.101 91.414l.877.877-1.754 3.508 3.508-1.754.877.877-7.016 3.508 3.508-7.016zm5.262 5.263l.877.877-5.262 5.262-.877-.877z"
                        fill="#d0d0d0"
                    />
                </g>
                <g fillRule="evenodd">
                    <path
                        d="M123.52 149.947c-2.179-2.18-.412-7.48 3.947-11.84s9.66-6.125 11.84-3.946c2.18 2.18.413 7.48-3.946 11.84s-9.66 6.126-11.84 3.946z"
                        fill="#d0d0d0"
                    />
                    <path
                        d="M126.15 147.318c-2.18-2.18-1.59-6.303 1.316-9.209s7.03-3.495 9.209-1.315c2.18 2.18 1.59 6.302-1.316 9.208s-7.029 3.495-9.209 1.316z"
                        fill="gray"
                    />
                    <path
                        d="M137.116 140.741l-.877.877-3.508-1.754 1.754 3.508-.877.877-3.508-7.016 7.016 3.508zm-5.263 5.262l-.877.877-5.263-5.262.877-.877z"
                        fill="#d0d0d0"
                    />
                </g>
                <g fillRule="evenodd">
                    <path
                        d="M78.585 134.157c2.18-2.18 7.481-.412 11.84 3.947s6.127 9.66 3.947 11.84c-2.18 2.179-7.48.412-11.84-3.947s-6.126-9.66-3.947-11.84z"
                        fill="#d0d0d0"
                    />
                    <path
                        d="M81.215 136.787c2.18-2.18 6.303-1.59 9.209 1.315s3.495 7.03 1.315 9.209c-2.18 2.18-6.302 1.59-9.209-1.316s-3.495-7.029-1.315-9.208z"
                        fill="gray"
                    />
                    <path
                        d="M87.792 147.752l-.877-.877 1.754-3.508-3.508 1.754-.877-.877 7.016-3.508-3.508 7.016zm-5.262-5.263l-.877-.877 5.262-5.262.877.877z"
                        fill="#d0d0d0"
                    />
                </g>
                <path
                ...
                />
                <path
                    d="M180.71 42.52a7.087 7.087 0 11-14.173 0 7.087 7.087 0 0114.173 0z"
                    fillRule="evenodd"
