...
function SvgGq(props: React.SVGProps<SVGSVGElement>) {
    return (
        <svg
        ...
        >
            ...
            <g stroke="#000">
                <path
                    d="M281.563 191.76h76.6V272c0 27-35.2 6.2-38.2 20.6-5.2-14.8-38.2 6.6-38.2-22.2 0-28-.2-78.64-.2-78.64z"
                    fill="#fff"
                    strokeWidth={0.96}
                />
                <path
                    d="M325.363 279.8s-1 1-2.8.2c-1.8-.8-2-51.4-2-51.4 4-4.4 7.2-5.8 7.2-5.8l2.4 2c-9 4.6-8.2 11.2-7.4 22.6.2 4.2.2 9.6 1.2 14.8 1.4 6.6 4.2 12.2 4.4 16.4.2 2.6-3 1.2-3 1.2z"
                    fill="#73452b"
                    strokeWidth={0.2}
                />
                <path
                    d="M319.163 221.6h3.6c-3 29-.4 46.2-.4 54.6 0 2.8 1.6 3.8 1.4 3.8-3.6 4-5.4-.2-5.4-.2z"
                    fill="#73452b"
                    strokeWidth={0.2}
                />
                <path
                    d="M313.563 279.8c-3.4 1.6-3.8-1.6-3.6-2 7.4-15 10.6-48 3.8-51.6l.4-3.2c2.6.8 5 4.2 5 4.2 1 37 0 52.2-.6 52.8-3.6 3.8-5-.6-5.2-1"
                    fill="#a36629"
                    strokeWidth={0.2}
                />
                <path
                    d="M313.363 279.2c-.6-3.2 5.2-11.4 4.8-20m5 7c1.8 5 2.6 9.4 2.2 13.6"
                    fill="none"
                    strokeWidth={0.2}
                />
                <path
                    d="M330.963 208c1.2-1.4 1.2-1.4 3.4-1.4.4-3 5.4-3 5.8.8 4-.8 4.8 1.6 3.2 4 3.8-1 7.2 0 6.2 4.4 6.8 1.8 4.2 6.6 1.2 7.6-.4 3-3.2 4-7 2.8-4.8 3.4-7.6 2.2-9.8-1.2-5.4.8-5.8-.4-8.2-3.4-4.2 1.8-5 1.8-8.6-.4-.2 2.8-1.2 2-3 1.8.2 3.6-1.2 5.2-4.4 4 2.4 5-3.8 7.2-6.8 3-2.8.2-3-.6-4.4-1.6-1.2 4-5.6 3.4-6.4 1.2-5.6-.8-5-3.8-.4-4 .4-3.2 3.2-2.6 5-2.2.2-2 1.4-1.6 2.4-1.2-.6-1.4-.2-2.2 1.6-2.6-2.6-3.4-1-4.6 1.6-5.8-1.4-3.2 1-3 2.8-3.2-.2-3.4.8-4 4.4-4.4-.4-1.2.2-2.2 2.2-2.2-1.2-3.4.4-4.18 4-3.6.6-4.94 11.2-2.6 10.4 4.2 3 .4 4 1 4.8 3.4z"
                    fill="#009a3b"
                    strokeWidth={0.2}
                />
                <path
                ...
                />
                <path
                    d="M317.363 180.52l-4.4.2-2.2 3.94-2.4-3.76-4.4.18 2-3.96-2.4-3.76 4.6-.2 2-3.94 2.4 3.76 4.4-.18-2 3.96zm-18.8 1.46l-4.4 1.08-1.2 4.26-3.2-3.2-4.2 1.04 1.2-4.26-3-3.24 4.2-1.06 1.2-4.28 3.2 3.2 4.4-1.04-1.4 4.28zm-18.2 3.74l-4 1.98-.2 4.44-3.8-2.44-4 1.96.4-4.44-3.8-2.46 4-2 .4-4.44 3.6 2.44 4-1.96-.2 4.44zm42.8-5.2l4.4.2 2 3.94 2.4-3.76 4.4.18-2-3.96 2.4-3.76-4.4-.2-2.2-3.94-2.4 3.76-4.4-.18 2 3.96zm18.8 1.46l4.2 1.08 1.2 4.26 3.2-3.2 4.2 1.04-1.2-4.26 3.2-3.24-4.4-1.06-1.2-4.28-3.2 3.2-4.2-1.04 1.2 4.28zm18 3.74l4 1.98.2 4.44 3.8-2.44 4 1.96-.2-4.44 3.6-2.46-4-2-.2-4.44-3.8 2.44-4-1.96.4 4.44z"
                    strokeWidth={0.7}
                    fill="gold"
                />
                <g fill="#fff" strokeWidth={0.7}>
                    <path d="M365.363 270.4l5 7.2 4.6-6.8-3.2-5.8zm-31.8 21l.4 7.2s2 0 3.8-.6c1.6-.6 3-1.8 3-1.8l-.2-3.8zm-26.8 0l-.4 7s-1.8 0-3.6-.4c-1.6-.4-3-1.4-3-1.4l-2-4.8zm-32.2-21l-5.2 7.2-5.6-9.2 4.2-4.4z" />
                    <path d="M299.563 305.8c0 6.8 41.2 6.8 41.2 0v-9.6c0 5-41.2 4-41.2 0z" />
