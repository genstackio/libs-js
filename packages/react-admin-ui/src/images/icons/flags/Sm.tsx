    ...
    return (
        <svg xmlns="http://www.w3.org/2000/svg" {...props}>
            ...
            <g stroke="#3a9d4f">
                ...
                <path
                    strokeLinejoin="round"
                    d="M404.502 266.397c-4.14-3.122-6.446-6.853-5.7-10.586-2.713-3.664-4.614-5.903-2.035-9.16 0 0-2.036-7.329-2.036-7.532-5.292-2.035-3.053-6.513-1.629-8.142-2.51-3.461-2.578-7.126-.203-10.382-.068-6.515 4.546-4.071 8.345 0 0 0 6.311 4.479 1.63 8.55 4.681 1.629 6.107 5.698 3.46 7.327 4.071 1.833 4.681 5.497 2.442 7.94 4.14 3.326 2.579 7.465 3.868 11.196l-8.142 10.789z"
                    fillRule="evenodd"
                    strokeWidth={2.369}
                    fill="#4fd46b"
                />
                <path
                    strokeLinejoin="round"
                    d="M411.831 236.064c-.203-.203-6.92-8.753-5.089-9.364-.406-2.647-2.441-5.497-1.22-8.142-3.325-3.325-3.394-7.26-.815-10.38-2.239-3.054-1.221-7.125 1.832-9.772-.95-5.022 2.579-6.175 5.7-7.126 2.307-8.075 6.038-5.971 8.142.203 3.19 2.782 2.715 6.99 1.63 10.18 3.799 2.578 1.492 5.766-.204 7.124l-9.976 27.277z"
                    fillRule="evenodd"
                    strokeWidth={2.369}
                    fill="#4fd46b"
                />
                <path
                    strokeLinejoin="round"
                    d="M410.815 193.106l-5.7-5.7c1.473-3.02 2.659-8.344-1.627-10.789-2.364-5.757-14.182-12.892-16.083.815-1.799-4.136-5.563-8.21-8.345-3.46-6.175-5.292-9.5-3.665-6.311 3.053 0 0-2.848 4.478 4.682 7.939.611.61-2.442 8.142 6.515 8.345-1.696 2.579 1.086 6.175 4.682 5.903-2.579 3.19 1.764 6.583 4.477 5.294-1.154 3.528-1.086 5.225 3.868 5.7l5.497 6.31 4.477 6.106 3.868-29.516z"
                    fillRule="evenodd"
                    strokeWidth={2.369}
                    fill="#4fd46b"
                />
                <path
                    d="M414.28 246.508c.288-.288 10.938-24.757 12.378-32.243M415.43 203.05s1.726 19.864-3.167 34.545m-29.648-54.7s21.879 21.015 23.893 29.651m-8.635-31.95s1.439 17.274 7.484 34.259m31.093 28.488s-21.879 18.425-32.53 34.545m11.792 29.952s-28.788 4.03-41.454 4.318m31.96 8.057s-35.698-.864-38.29-3.454m20.433-42.902c0 .287-18.136 30.226-18.712 40.015"
                    strokeLinecap="round"
                    strokeWidth={2.22}
                    fill="none"
                />
            ...
            />
            <path
                d="M273.814 123.571a3.346 3.346 0 11-6.692 0 3.346 3.346 0 016.692 0zm-7.274 4.364a3.346 3.346 0 11-6.692 0 3.346 3.346 0 016.692 0zm22.403-5.383a3.346 3.346 0 11-6.692 0 3.346 3.346 0 016.692 0zm9.311.728a3.346 3.346 0 11-6.692 0 3.346 3.346 0 016.692 0zm8.292-.437a3.346 3.346 0 11-6.692 0 3.346 3.346 0 016.692 0z"
                fillRule="evenodd"
                stroke="#000"
                strokeWidth={1.111}
                fill="#fff"
            />
            <path
                d="M325.874 117.504a8.583 8.583 0 11-17.166 0 8.583 8.583 0 0117.166 0z"
                fillRule="evenodd"
                stroke="#7d6c00"
                strokeWidth={1.111}
                fill="#fd0"
            ...
            />
            <path
                d="M323.546 143.045a5.964 5.964 0 11-11.93 0 5.964 5.964 0 0111.93 0z"
                fillRule="evenodd"
                stroke="#000"
                strokeWidth={1.111}
                fill="#fff"
            />
            <path
                d="M322.685 131.995a5.383 5.383 0 11-10.765 0 5.383 5.383 0 0110.765 0z"
                fillRule="evenodd"
                stroke="#000"
                strokeWidth={1.109}
                fill="#fff"
            />
            <path
                d="M315.487 109.055c0-.926-.028-4.165.037-4.295l-3.572-.064.102-3.175 3.1-.037.037-2.775h4.395v2.544h3.47l-.072 3.378-3.6-.037-.03 4.526-3.867-.065z"
                fillRule="evenodd"
                stroke="#7d6c00"
                strokeWidth={1.111}
                fill="#fd0"
            ...
            />
            <path
                d="M277.343 177.132c28.495-2.918 54.904-1.877 79.23 0l3.127-8.967c-27.66-5.003-46.773-5.628-82.982-.624l.625 9.59z"
                fillRule="evenodd"
                stroke="#7d6c00"
                strokeWidth={2.369}
                fill="#fd0"
            />
            <path
                d="M314.121 329.377c.205-1.43.408-2.762.613-4.191 2.834.763 4.996.468 7.35-.402.815-1.225 1.633-2.45 2.45-3.676l-1.838-2.142c-1.615.348-2.941 1.85-3.98 3.158-1.628.077-3.064-.71-4.595-1.016l-1.53-6.43c-1.52-1.795-4.671-1.668-3.982 1.531l.307 2.45c.613 1.531.841 3.639 1.837 4.785v2.511c1.123 1.141 2.246 2.28 3.368 3.422zm1.216-18.29c-2.13 1.056-4.659-.78-7.349-1.837-2.45-.168-4.419 1.872-7.349 1.224.535-1.59 1.837-1.837 2.757-2.756-.673-4.131 1.53-5.512 2.144-5.512.61 0 3.061.613 3.061.613l2.45.306c1.43 2.654 3.433 5.02 4.286 7.962z"
                fillRule="evenodd"
                fill="#c76e2e"
            />
            <path
                d="M300.779 366.089c7.066-11.472 56.259-34.508 102.422-84.251-46.99 45.243-76.357 56.35-114.812 83.974l12.39.277z"
                fillRule="evenodd"
                stroke="#e9bf00"
                strokeWidth={2.369}
                fill="#ffe100"
            />
            <path
                d="M368.406 313.186a3.582 3.582 0 11-7.163 0 3.582 3.582 0 017.163 0zm34.38-34.863a4.06 4.06 0 11-8.118 0 4.06 4.06 0 018.118 0zm11.466-29.61a3.582 3.582 0 11-7.163 0 3.582 3.582 0 017.163 0zM403.02 210.28a3.582 3.582 0 11-7.164 0 3.582 3.582 0 017.164 0z"
                fillRule="evenodd"
                stroke="#68300e"
                strokeWidth={1.111}
                fill="#9d4916"
            ...
            />
            <path
                d="M235 206.581c3.35-9.437 10.048-25.573 10.656-25.573m-18.568 45.362c-.608-6.7-3.956-24.662-4.26-26.488"
                stroke="#00a400"
                strokeLinecap="round"
                strokeWidth={2.22}
                fill="none"
            ...
            <g fillRule="evenodd">
                <path
                    d="M333.56 366.355l13.49.275c-44.787-41.942-130.599-60.205-118.667-137.39-12.298 83.701 70.117 91.41 105.177 137.115z"
                    stroke="#e9bf00"
                    strokeWidth={2.369}
                    fill="#ffe100"
                />
                <path
                    d="M235.417 212.661a4.298 4.298 0 11-8.596 0 4.298 4.298 0 018.596 0zm-2.632 23.636a4.06 4.06 0 11-8.118 0 4.06 4.06 0 018.118 0zm3.815 33.681a3.582 3.582 0 11-7.164 0 3.582 3.582 0 017.164 0zm31.276 37.245a3.582 3.582 0 11-7.163 0 3.582 3.582 0 017.163 0zm4.536 10.684a3.582 3.582 0 11-7.163 0 3.582 3.582 0 017.163 0z"
                    stroke="#68300e"
                    strokeWidth={1.111}
                    fill="#9d4916"
                />
            ...
            <g fillRule="evenodd" fill="#fff">
                <g stroke="#000" strokeWidth={1.111}>
                    ...
                    />
                    <path d="M184.732 337.954a3.63 3.63 0 11-7.26 0 3.63 3.63 0 017.26 0zm-.952 17.957a3.63 3.63 0 11-7.26 0 3.63 3.63 0 017.26 0z" />
                </g>
                <g stroke="#000" strokeWidth={1.111}>
                    ...
                    />
                    <path d="M449.723 338.02a3.63 3.63 0 107.261 0 3.63 3.63 0 00-7.26 0zm.952 17.956a3.63 3.63 0 107.26 0 3.63 3.63 0 00-7.26 0z" />
                </g>
