...
function SvgKr(props: React.SVGProps<SVGSVGElement>) {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" {...props}>
            <defs>
                <clipPath id="kr_svg__a">
                    <path fillOpacity={0.67} d="M-95.808-.44h682.67v512h-682.67z" />
                </clipPath>
            </defs>
            <g fillRule="evenodd" clipPath="url(#kr_svg__a)" transform="translate(89.82 .412) scale(.9375)">
                <path fill="#fff" d="M610.61 511.56h-730.17v-512h730.17z" />
                <path
                    d="M251.871 256.021c0 62.137-50.372 112.508-112.507 112.508-62.137 0-112.507-50.372-112.507-112.508 0-62.137 50.371-112.507 112.507-112.507 62.137 0 112.507 50.372 112.507 112.507z"
                    fill="#fff"
                />
                <path
                    d="M393.011 262.55c0 81.079-65.034 146.803-145.261 146.803S102.488 343.63 102.488 262.55s65.034-146.804 145.262-146.804 145.26 65.725 145.26 146.804z"
                    fill="#c70000"
                />
