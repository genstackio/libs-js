...
export type box_color = 'primary' | 'secondary' | 'success' | 'info' | 'warning' | 'danger' | 'light' | 'dark' | 'default';
...
export type corner = 'rounded' | 'rounded-small' | 'square' | 'top-rounded' | 'left-rounded' | 'top-rounded-small' | 'left-rounded-small';
...
export type tab_item = {title?: rich_text, content?: rich_text, disabled?: boolean};
