...
export function ItemCarrousselItem({ className, title, items = [] }: ItemCarrousselItemProps) {
...
export interface ItemCarrousselItemProps extends AsComponent, WithTitle, WithItems {}

export default ItemCarrousselItem;
