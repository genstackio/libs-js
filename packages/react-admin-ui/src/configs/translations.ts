...
const common = {
    ...
    unit_buildingthickness_mm: 'mm',
    unit_buildingthickness_cm: 'cm',
    unit_buildingthickness_dm: 'dm',
    unit_buildingthickness_m: 'm',
    unit_buildingthickness_ft: 'ft',
    unit_buildingthickness_in: 'inch',
    unit_buildingthickness_yd: 'yd',

    unit_buildingyoungmodule_pa: 'Pa',
    unit_buildingyoungmodule_mpa: 'MPa',

    unit_buildingsize_mm: 'mm',
    unit_buildingsize_cm: 'cm',
    unit_buildingsize_dm: 'dm',
    unit_buildingsize_m: 'm',
    unit_buildingsize_ft: 'ft',
    unit_buildingsize_yd: 'yd',
    unit_buildingsize_in: 'inch',

    unit_buildingvolume_m3: 'm³',
    unit_buildingvolume_l: 'L',

    unit_buildingdistance_m: 'm',
    unit_buildingdistance_km: 'km',
    unit_buildingdistance_yd: 'yd',
    unit_buildingdistance_mi: 'mi',

    unit_buildingcharge_g: 'g',
    unit_buildingcharge_kg: 'kg',
    unit_buildingcharge_n: 'N',
    unit_buildingcharge_kn: 'kN',

    unit_buildingpressure_knm2: 'kNm²',
    unit_buildingpressure_kn: 'kN',
    unit_buildingpressure_kndm2: 'kNdm²',
    unit_buildingpressure_mpa: 'MPa',
    unit_buildingpressure_pa: 'Pa',
};
...
export default {
    'fr-FR': {
        translation: {
            ...
            field_buildingthickness_value_label: 'Epaisseur',
            field_buildingthickness_unit_label: 'Unité',
            field_buildingyoungmodule_value_label: 'Module de Young',
            field_buildingyoungmodule_unit_label: 'Unité',
            field_buildingdistance_value_label: 'Distance',
            field_buildingdistance_unit_label: 'Unité',
            field_buildingsize_value_label: 'Taille',
            field_buildingsize_unit_label: 'Unité',
            field_buildingvolume_value_label: 'Volume',
            field_buildingvolume_unit_label: 'Unité',
            field_buildingcharge_value_label: 'Charge',
            field_buildingcharge_unit_label: 'Unité',
            field_buildingpressure_value_label: 'Pression',
            field_buildingpressure_unit_label: 'Unité',
            ...
            field_publicfile_label: 'Public File',
            field_publicfile_placeholder: 'Public File',
            field_publicfile_helper: 'Public File',
    ...
    'it-IT': {
        translation: {
            ...
            locale_fr_fr: 'Francese (Francia)',
            locale_fr_lu: 'Francese (Lussemburgo)',
            locale_fr_mc: 'Francese (Monaco)',
            locale_fr_be: 'Francese (Belgio)',
            locale_fr_ca: 'Francese (Canada)',
            locale_en_gb: 'Inglese (Gran Bretagna)',
            locale_en_us: 'Inglese (USA)',
            locale_it_it: 'Italiano (Italia)',
            locale_es_es: 'Spagnolo (Spagna)',
            ...
            field_locale_placeholder: 'Language',

            field_country_label: 'Paese',
            field_country_helper: 'Paese',
            field_country_placeholder: 'Paese',

            field_logoimage_label: 'Logo',
            field_logoimage_placeholder: 'immagine de logo',
            field_logoimage_helper: 'Logo della collezione principale',
            field_logoaltimage_label: 'Logo alternativo',
            field_logoaltimage_placeholder: 'immagine alternativa del logo',
            field_logoaltimage_helper: 'Logo alternativo della collezione',
            field_bannerimage_label: 'Bandiera',
            field_bannerimage_placeholder: 'immagine della bandiera',
            field_bannerimage_helper: 'Bandiera principale del gioco',
            field_banner2image_label: 'Bandiera secondaria',
            field_banner2image_placeholder: 'Immagine secondaria del banner',
            field_banner2image_helper: 'Bandiera secondaria della collezione',
            field_twittershareimage_label: 'Immagine di Twitter',
            field_twittershareimage_placeholder: 'immagine per Twitter',
            field_twittershareimage_helper: 'Immagine Twitter della collezione',
            field_facebookshareimage_label: 'Immagine di Facebook',
            field_facebookshareimage_placeholder: 'Immagine di Facebook',
            field_facebookshareimage_helper: 'Immagine Facebook della collezione',
            field_flyerimage_label: 'Flyer',
            field_flyerimage_placeholder: 'immagine del volantino',
            field_flyerimage_helper: 'Volantino della collezione',
            field_mainimage_label: 'Immagine principale',
            field_mainimage_placeholder: 'Immagine principale',
            field_mainimage_helper: 'Immagine principale della collezione',
            field_datafile_label: 'Data File',
            field_datafile_placeholder: 'Data Field',
            field_datafile_helper: 'Data Field',
            field_backgroundimage_label: 'Immagine di sfondo',
            field_backgroundimage_placeholder: 'immagine di sfondo',
            field_backgroundimage_helper: 'Immagine di sfondo della collezione',

            field_currency_label: 'Moneta',
            field_currency_placeholder: 'Moneta',
            field_currency_helper: 'Moneta',
    ...
    'en-GB': {
        translation: {
            ...
            field_buildingsize_value_label: 'Size',
            field_buildingsize_unit_label: 'Unit',
            field_buildingvolume_value_label: 'Volume',
            field_buildingvolume_unit_label: 'Unit',
            field_buildingcharge_value_label: 'Charge',
            field_buildingcharge_unit_label: 'Unit',
            field_buildingpressure_value_label: 'Pressure',
            field_buildingpressure_unit_label: 'Unit',
            ...
            locale_en_gb: 'English (Great Britain)',
            locale_en_us: 'English (USA)',
            ...
            field_country_helper: 'Country',
            field_country_placeholder: 'Country',

            field_logoimage_label: 'Logo',
            field_logoimage_placeholder: 'Logo image',
            field_logoimage_helper: 'Main logo of the collection',
            field_logoaltimage_label: 'Alternative logo',
            field_logoaltimage_placeholder: 'alternative logo image',
            field_logoaltimage_helper: 'Alternative logo of the collection',
            field_bannerimage_label: 'Banner',
            field_bannerimage_placeholder: 'banner image',
            field_bannerimage_helper: 'Main banner of the collection',
            field_banner2image_label: 'Secondary banner',
            field_banner2image_placeholder: 'secondary banner image',
            field_banner2image_helper: 'Secondary banner of the collection',
            field_twittershareimage_label: 'Twitter image',
            field_twittershareimage_placeholder: 'image for Twitter',
            field_twittershareimage_helper: 'Twitter image of the collection',
            field_facebookshareimage_label: 'Facebook image',
            field_facebookshareimage_placeholder: 'image for Facebook',
            field_facebookshareimage_helper: 'Facebook image of the collection',
            field_flyerimage_label: 'Flyer',
            field_flyerimage_placeholder: 'flyer image',
            field_flyerimage_helper: 'Flyer of the collection',
            field_mainimage_label: 'Main image',
            field_mainimage_placeholder: 'main image',
            field_mainimage_helper: 'Main image of the collection',
            field_datafile_label: 'Data File',
            field_datafile_placeholder: 'Data Field',
            field_datafile_helper: 'Data Field',
            field_backgroundimage_label: 'Background image',
            field_backgroundimage_placeholder: 'background image',
            field_backgroundimage_helper: 'Collection background image',

            field_title_label: 'Title',
            field_title_placeholder: 'This is the title',
            field_title_helper: 'Fill in the title here',
            field_bannervideourl_label: 'Banner video',
            field_bannervideourl_placeholder: 'https://...',
            field_bannervideourl_helper: 'Fill in the banner video url',
            field_banner2videourl_label: 'Secondary banner video',
            field_banner2videourl_placeholder: 'https://...',
            field_banner2videourl_helper: 'Fill in the secondary banner video url',
            field_mainvideourl_label: 'Main video',
            field_mainvideourl_placeholder: 'https://...',
            field_mainvideourl_helper: 'Fill in the main video url',
            field_mainshortvideourl_label: 'Main short video',
            field_mainshortvideourl_placeholder: 'https://...',
            field_mainshortvideourl_helper: 'Fill in the main short video url',
            field_mainlongvideourl_label: 'Main long video',
            field_mainlongvideourl_placeholder: 'https://...',
            field_mainlongvideourl_helper: 'Fill in the main long video url',
            field_backgroundvideourl_label: 'Background video',
            field_backgroundvideourl_placeholder: 'https://...',
            field_backgroundvideourl_helper: 'Fill in the background video url',

            field_currency_label: 'Currency',
            field_currency_placeholder: 'Currency',
            field_currency_helper: 'Currency',
